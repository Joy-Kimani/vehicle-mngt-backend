...
//get all
export const getAllVehicleSpecs = async (c) => {
    try {
...
//get by id
export const getVehicleSpecsById = async (c) => {
...
//create
export const createVehicleSpecs = async (c) => {
    try {
...
//update
export const updateVehicleSpecs = async (c) => {
    try {
        const vehicle_spec_id = parseInt(c.req.param("vehicle_spec_id"));
        const body = await c.req.json();
        // check if exists
...
//delete
export const deleteVehicleSpecs = async (c) => {
    const vehicle_spec_id = parseInt(c.req.param("vehicle_spec_id"));
    try {
