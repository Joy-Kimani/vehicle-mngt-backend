...
//get all
export const getAllTickets = async (c) => {
    try {
...
//get by id
export const getTicketById = async (c) => {
...
//delete
export const deleteTicket = async (c) => {
    const ticket_id = parseInt(c.req.param("ticket_id"));
    try {
...
//   }
// };
export const getAllTicketsController = async (c) => {
    try {
        const pool = await getDbPool();
...
//
export const getUserTicketsController = async (c) => {
...
// ✔ Create new ticket
//
export const createTicketController = async (c) => {
...
//
export const getTicketMessagesController = async (c) => {
...
//
export const sendMessageController = async (c) => {
    const ticket_id = c.req.param("ticket_id");
...
//
export const resolveTicketController = async (c) => {
    const ticket_id = c.req.param("ticket_id");
    try {
        const pool = await getDbPool();
        await pool
