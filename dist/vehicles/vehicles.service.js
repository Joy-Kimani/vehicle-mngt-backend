...
//get by id
export const getVehicleByIdServices = async (vehicle_id) => {
    const db = getDbPool();
...
//create
export const createVehicleSpecController = async (c) => {
...
export const createVehicleWithSpec = async (c) => {
    const body = await c.req.json();
    const db = getDbPool();
...
//update
export const updateVehicleService = async (c) => {
    const body = await c.req.json();
    const db = getDbPool();
    const { vehicle_spec, vehicle } = body;
    try {
