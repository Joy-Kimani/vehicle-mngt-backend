...
//get all bookings
export const getAllBookings = async (c) => {
    try {
...
//     }
// };
export const getBookingById = async (c) => {
    const booking_id = Number(c.req.param("bookingId"));
    if (isNaN(booking_id)) {
...
export const createBooking = async (c) => {
    ...
    try {
        const result = await bookingServices.createBookingService(body.user_id, body.vehicle_id, body.booking_date, body.return_date, body.booking_status);
...
export const updateBooking = async (c) => {
    try {
        ...
        const updatedBooking = await bookingServices.updateBookingService(booking_id, body.user_id, body.vehicle_id, body.booking_date, body.return_date, body.booking_status);
        if (!updatedBooking) {
...
//delete
export const deleteBooking = async (c) => {
    const booking_id = parseInt(c.req.param('booking_id'));
    try {
        //check if it exists
...
export const bookingPayment = async (c) => {
...
export const extendBooking = async (c) => {
    const body = await c.req.json();
    try {
...
export const getBookingsByUser = async (c) => {
...
export const getBookingManagement = async (c) => {
    const booking_id = parseInt(c.req.param('booking_id'));
    try {
...
export const getFetchBookingsMangement = async (c) => {
    try {
