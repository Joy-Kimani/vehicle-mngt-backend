...
export const getBookingByIdService = async (booking_id) => {
    const db = getDbPool();
...
export const createBookingService = async (user_id, vehicle_id, booking_date, return_date, booking_status = "Pending") => {
    const db = getDbPool();
...
// };
export const updateBookingService = async (booking_id, user_id, vehicle_id, booking_date, return_date, booking_status) => {
    const db = getDbPool();
    const result = await db.request()
        .input("booking_id", booking_id)
        .input("user_id", user_id)
...
export const getBookingByUserService = async (user_id) => {
    const db = getDbPool();
    const result = await db.request()
        .input('user_id', user_id)
...
export const bookingPaymentService = async (booking_id) => {
    const db = getDbPool();
    const result = await db.request()
        .input('booking_id', booking_id)
        .query(`
...
// extend booking
export const extendBookingService = async (booking_id, new_return_date) => {
    const db = getDbPool();
    await db.request()
        .input("booking_id", booking_id)
...
//cancel booking
export const cancelBookingService = async (booking_id) => {
    const db = getDbPool();
    const result = await db.request()
        .input('booking_id', booking_id)
        .query(`
...
export const getBookingsByUserService = async (user_id) => {
    const db = getDbPool();
    const result = await db.request()
        .input('user_id', user_id)
...
export const getBookingManagementService = async (booking_id) => {
...
export const fetchBookingsManagementService = async (payload) => {
    const db = getDbPool();
    const results = [];
